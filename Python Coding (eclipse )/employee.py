...
class Manager(object):  # 2 points
    ...
    def __init__(self, first_name,  last_name, title, hours_per_week, hourly_rate, bonus_percent):
        super().__init__(first_name,  last_name, title, hours_per_week, hourly_rate) #call super is called constructor chaining
        try:
...
if __name__ == '__main__':
    e = Employee('Brian', 'Borowski', 'Cashier', 20, 10)
    print(e)
    m = Manager('Donald', 'Trump', 'Boss', 30, 20, 10)
    print(m)
