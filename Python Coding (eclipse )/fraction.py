class Fraction(object):
    ...
    def __init__(self, numerator=0, denominator=1):     #this is a constructor... has default arguments
    ...
    def __add__(self, other):
        ...
        '''
        num = self.__numerator * other.__denominator + self.__numerator * other.__denominator  
    ...
    def __repr__(self):
        ...
        '''
        return str(self.__class__.__name__) + "(" + str(self.__numerator) + \
...
if __name__ == '__main__':
    ...
    lst = [Fraction(2,5), Fraction(1,2), Fraction(1,6), Fraction(1,2)]
    lst.sort()
    print(lst)
